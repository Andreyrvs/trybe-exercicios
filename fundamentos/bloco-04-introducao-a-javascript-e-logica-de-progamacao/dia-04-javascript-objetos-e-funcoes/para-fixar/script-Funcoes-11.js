function salaryWithoutTax(grossSalary) {
  ...
  let aliquotIR = {
    aliquot7PercentIR: (baseSalary / 100 * 7.5) - portionIR.portionIR7,
    aliquot15PercentIR: (baseSalary / 100 * 15) - portionIR.portionIR15,
    aliquot22PercentIR: (baseSalary / 100 * 22.5) - portionIR.portionIR22,
    aliquot27PercentIR: (baseSalary / 100 * 27.5) - portionIR.portionIR27,
  ...
  if (baseSalary <= 1903.98) {
    ...
    netSalary = baseSalary - aliquotIR.aliquot7PercentIR;

    console.log('R$' + netSalary)
  } else if (baseSalary > 2826.66 && baseSalary <= 3751.05) {
    netSalary = baseSalary - aliquotIR.aliquot15PercentIR;

    console.log('R$' + netSalary)
  } else if (baseSalary > 3751.06 && baseSalary <= 4664.68) {
    netSalary = baseSalary - aliquotIR.aliquot22PercentIR;

    console.log('R$' + netSalary)
  } else if (baseSalary > 4664.68) {
    netSalary = baseSalary - aliquotIR.aliquot27PercentIR;
    console.log('R$' + netSalary)
  }
  
}

salaryWithoutTax(9000)